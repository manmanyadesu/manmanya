...
def archive_single_post(post_no, page, drive_service, creds, update_comments_only=False):
    ...
    if update_comments_only and os.path.exists(html_path):
        print(f"🔄 [{post_no}번 글] 기존 이미지 주소 보존 및 최신 디자인/댓글 조립 중...")
        try:
